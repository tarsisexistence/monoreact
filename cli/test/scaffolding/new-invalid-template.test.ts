...
describe('[bin.scaffolding.new-invalid-template]', () => {
  ...
  it('should fail with exit code 1', () => {
    const output = smartExec('node ../../../dist/bundle.cjs new myProject --template someInvalidTemplateName');
    expect(output.code).toBe(1);
  });

  it('should not create new project', () => {
    smartExec('node ../../../dist/bundle.cjs new myProject --template someInvalidTemplateName');
